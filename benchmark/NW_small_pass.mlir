  ...
  func.func @Needleman_Wunsch(%arg0: memref<?xmemref<?xi32>>, %arg1: memref<?xmemref<?xi32>>, %arg2: memref<?xmemref<?xmemref<?xi32>>>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 2048 {
      affine.for %arg4 = 0 to 513 {
        ...
        %5 = affine.load %4[0] : memref<?xmemref<?xi32>>
        %6 = arith.subi %c0_i32, %3 : i32
        affine.store %6, %5[%arg3] : memref<?xi32>
        %7 = affine.load %arg2[0] : memref<?xmemref<?xmemref<?xi32>>>
        %8 = affine.load %7[%arg4] : memref<?xmemref<?xi32>>
        affine.store %6, %8[%arg3] : memref<?xi32>
      }
    }
    affine.for %arg3 = 0 to 2048 step 8 {
      affine.for %arg4 = 1 to 513 {
        affine.for %arg5 = 1 to 513 {
          %3 = affine.load %arg2[%arg4 - 1] : memref<?xmemref<?xmemref<?xi32>>>
          %4 = affine.load %3[%arg5] : memref<?xmemref<?xi32>>
          %5 = vector.load %4[%arg3] : memref<?xi32>, vector<8xi32>
          %6 = arith.addi %5, %0 : vector<8xi32>
          %7 = affine.load %arg2[%arg4] : memref<?xmemref<?xmemref<?xi32>>>
          %8 = affine.load %7[%arg5 - 1] : memref<?xmemref<?xi32>>
          %9 = vector.load %8[%arg3] : memref<?xi32>, vector<8xi32>
          %10 = arith.addi %9, %0 : vector<8xi32>
          %11 = affine.load %3[%arg5 - 1] : memref<?xmemref<?xi32>>
          %12 = vector.load %11[%arg3] : memref<?xi32>, vector<8xi32>
          %13 = affine.load %arg0[%arg4 - 1] : memref<?xmemref<?xi32>>
          %14 = vector.load %13[%arg3] : memref<?xi32>, vector<8xi32>
          %15 = affine.load %arg1[%arg4 - 1] : memref<?xmemref<?xi32>>
          %16 = vector.load %15[%arg3] : memref<?xi32>, vector<8xi32>
          %17 = arith.cmpi eq, %14, %16 : vector<8xi32>
          %18 = arith.extui %17 : vector<8xi1> to vector<8xi32>
          %19 = arith.muli %18, %1 : vector<8xi32>
          %20 = arith.subi %12, %19 : vector<8xi32>
          %21 = arith.addi %20, %2 : vector<8xi32>
          %22 = arith.cmpi slt, %6, %10 : vector<8xi32>
          %23 = arith.select %22, %10, %6 : vector<8xi1>, vector<8xi32>
          %24 = arith.cmpi slt, %23, %21 : vector<8xi32>
          %25 = arith.select %24, %21, %23 : vector<8xi1>, vector<8xi32>
          %26 = affine.load %7[%arg5] : memref<?xmemref<?xi32>>
          vector.store %25, %26[%arg3] : memref<?xi32>, vector<8xi32>
        }
      }
    }
    return
