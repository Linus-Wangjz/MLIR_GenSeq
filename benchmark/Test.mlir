...
module{  
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    %ret1 = affine.for %arg0 = 0 to 256 step 16 {
      %c42_i32 = arith.constant 42 : i32
      %0 = vector.broadcast %c42_i32 : i32 to vector<16xi32>
      %c42_i32_0 = arith.constant 42 : i32
      %1 = vector.broadcast %c42_i32_0 : i32 to vector<16xi32>
      %ret2 = affine.for %arg1 = 0 to 512 {
        %ret3 = affine.for %arg2 = 0 to 512 {
          %2 = arith.addi %1, %0 : vector<16xi32>
          %c0 = arith.constant 2 : i32
          %c0_i32 = vector.extractelement %2[%c0 : i32]: vector<16xi32>
          affine.yield %c0_i32 : i32
        }
        affine.yield %ret3 : i32
      }
      affine.yield %ret2 : i32
    }
    
    %0 = llvm.mlir.addressof @str0 : !llvm.ptr
    %1 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<10 x i8>
    %3 = llvm.call @printf(%1) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr) -> i32
    return %ret1 : i32
  }
}
// }
