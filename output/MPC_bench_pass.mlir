    ...
    affine.for %arg2 = 0 to 2048 step 8 {
      affine.for %arg3 = 1 to 512 {
        affine.for %arg4 = 1 to 512 {
          ...
          %18 = vector.load %17[%arg2] : memref<?xi32>, vector<8xi32>
          %19 = affine.load %16[%arg4] : memref<?xmemref<?xi32>>
          %20 = vector.load %19[%arg2] : memref<?xi32>, vector<8xi32>
          %21 = affine.load %arg1[%arg3] : memref<?xmemref<?xmemref<?xi32>>>
          %22 = affine.load %21[%arg4 - 1] : memref<?xmemref<?xi32>>
          %23 = vector.load %22[%arg2] : memref<?xi32>, vector<8xi32>
          %24 = arith.cmpi sgt, %18, %20 : vector<8xi32>
          %25 = arith.select %24, %20, %18 : vector<8xi1>, vector<8xi32>
          %26 = arith.cmpi sgt, %25, %23 : vector<8xi32>
          %27 = arith.select %26, %23, %25 : vector<8xi1>, vector<8xi32>
          ...
          %31 = vector.load %30[%arg2] : memref<?xi32>, vector<8xi32>
          %32 = arith.addi %27, %31 : vector<8xi32>
          vector.store %32, %28[%arg2] : memref<?xi32>, vector<8xi32>
        }
      }
    }
    %9 = call @clock() : () -> i64
